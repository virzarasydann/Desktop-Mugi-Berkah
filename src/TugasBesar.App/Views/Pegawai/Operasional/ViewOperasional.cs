...
namespace TugasBesar.App.Views.Pegawai.Operasional
{
    public partial class ViewOperasional : UserControl, IOperasionalObserver
    {
        ...
        /// <summary>
        /// Membuat kolom grid sekali di awal (id, Diinput Oleh, Nama, Harga, Aksi, Hapus)
        /// agar header tetap terlihat meskipun data operasional masih kosong.
        /// </summary>
        ...
        /// <summary>
        /// Memperbarui isi grid dari data cache. Kolom tidak lagi dibuat ulang di sini
        /// (sudah dibuat sekali oleh BuatKolomTetap), jadi header tetap tampil meski data kosong.
        /// </summary>
        ...
        private void SesuaikanUkuranGrid()
        {
            ...
            // Tambahan kecil untuk border grid agar scrollbar tidak muncul tanpa alasan
